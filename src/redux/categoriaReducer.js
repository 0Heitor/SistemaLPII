...
export const buscarCategorias = createAsyncThunk('categorias/buscarCategorias', async () => {
    try { 
...
export const adicionarCategoria = createAsyncThunk('categorias/adicionar', async (categoria) => {
...
export const atualizarCategoria = createAsyncThunk('categorias/atualizar', async (categoria) => {
    const resposta = await fetch(urlBase, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
...
export const removerCategoria = createAsyncThunk('categorias/remover', async (categoria) => {
    const resposta = await fetch(urlBase, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
